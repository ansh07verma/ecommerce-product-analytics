...
Engineering effort is treated as a real investment cost:
- **Effort**: 1.5 person-months (Senior Search Engineer) `[PRODUCT ASSUMPTION]`
- **Loaded Monthly Rate**: $15,000 / month `[PRODUCT ASSUMPTION]`
- **Development Cost**: $22,500 one-time `[PRODUCT ASSUMPTION]`
- **Annual Cloud & Maintenance**: $6,000 / year ($200/mo infra + $300/mo maintenance) `[PRODUCT ASSUMPTION]`
- **Total Year-1 Cost**: **$28,500.00** `[PRODUCT ASSUMPTION]`

### Strategic Scaling Economics
- **At 1x Current Traffic (15.7 searches/day)**: Annualized net GMV is $1,809. Standalone Year-1 ROI is negative (-93.7%).
- **At 10x Scale (157 searches/day)**: Annualized net GMV is $18,087.
- **At 100x Scale (1,570 searches/day - National Marketplace)**: Annualized net GMV is **$180,869**, delivering an ROI of **+534%** and a payback period of **1.9 months**.

---

## 9. Break-Even Analysis

Break-even requirements for common corporate annual GMV hurdles:

$$	ext{Required CTR Lift} = rac{	ext{Target Annual GMV}}{	ext{Recovered Searches} 	imes 	ext{Funnel Value / View}}$$

1. **$1,000 Target**: Requires **+1.94 pp CTR lift** (treatment CTR = 5.02%) at 91.81% recovery $	o$ **FEASIBLE**.
2. **$2,500 Target**: Requires **+4.84 pp CTR lift** (treatment CTR = 7.92%) $	o$ **CHALLENGING**.
3. **$5,000+ Target**: Requires $>9.68	ext{ pp CTR lift}$, which is unachievable on current traffic without expanding the eligible query definition.
...
- `[PRODUCT ASSUMPTION]`: Explicit scenario parameters (target lift +3.5 pp, cannibalization 25%, engineering cost $28.5K).
