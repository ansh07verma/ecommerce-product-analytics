...
- **Retrieval Latency** is sub-millisecond to low single-digit milliseconds (mean: **0.89 ms**, p95: **1.08 ms**), well within the proposed production budget (p95 <= 250 ms).
...
| **System Latency** | Mean Latency | **0.89 ms** | In-memory tokenized inverted index |
| **System Latency** | p95 Latency | **1.08 ms** | Proposed SLA: p95 <= 250 ms (PASS) |
| **System Latency** | p99 Latency | **1.7 ms** | Peak execution time |
